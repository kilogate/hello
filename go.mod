...
require (
	code.byted.org/aiops/apm_vendor_byted v0.0.6 // indirect
	code.byted.org/aiops/metrics_codec v0.0.5 // indirect
	...
	code.byted.org/gopkg/metainfo v0.0.12 // indirect
	code.byted.org/gopkg/metrics v1.4.21 // indirect
	code.byted.org/gopkg/metrics/v3 v3.1.19 // indirect
	code.byted.org/gopkg/metrics/v4 v4.0.13 // indirect
	code.byted.org/gopkg/metrics_core v0.0.12 // indirect
	code.byted.org/gopkg/net2 v1.5.0 // indirect
	code.byted.org/gopkg/stats v1.2.2 // indirect
	...
	github.com/snakorse/pool v0.2.4 // indirect
